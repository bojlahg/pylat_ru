"""Pinned full-JLanguageTool ordering parity for the complete Russian rule set.

Unlike the Task-0011 combined fixture, nothing is disabled here: all 23 ordinary
Java-rule equivalents run with their pinned default state alongside the XML
grammar rules.
"""
...
FIXTURE = Path("tests/fixtures/oracle_java_rules_0012_combined.json")
...
def test_combined_full_russian_pipeline_matches_pinned_order(case: dict) -> None:
    tool = LanguageToolRU(
